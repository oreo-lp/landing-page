        ...
        <nav className="w-full flex justify-between gap-6 relative">
          ...
          <div className="min-w-max inline-flex relative">
            <a href="/" className="relative flex items-center gap-3">
              <img src={logo} alt="EageAI Logo" className="w-10 h-10" />
              <div className="flex text-lg font-semibold text-heading-1">
                EageAI
              </div>
            </a>
          </div>
          ...
          <div
            className="flex flex-col lg:flex-row w-full lg:justify-between lg:items-center 
                        ...
                        border-x border-x-box-border lg:border-x-0 lg:h-auto h-9 overflow-hidden"
          >
            {/* 导航栏 */}
            <ul
